...
public class Author {
   ...
   * 
   * If the specified email address is <code>null</code>, then the email address
   * is set to an empty {@link String}.
   * 
  ...
  public boolean equals(Author author)
  {
	 ...
	 else if(this.birthday.equals(author.birthday)&&this.email.equals(author.email)&&this.firstName.equals(author.firstName)&&this.lastName.equals(author.lastName)&&this.residence.equals(author.residence))
	 {
		 return true;
	 }
	 else return false;
