...
public class Document {
  ...
  public boolean equals(Document document)
  {
	  ...
	  if(this.author.equals(document.author)&&this.description.equals(document.description)&&this.language.equals(document.language)&&this.releaseDate.equals(document.releaseDate)&&this.title.equals(document.title)&&this.wordCounts.equals(document.wordCounts))
	  {
		  return true;
	  }
	  else return false;
